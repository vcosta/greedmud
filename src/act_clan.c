...
/*
    ...
    This file was written by Zen <vasc@rnl.ist.utl.pt>
 */
...
/*
 * "leavecla" command is a trap to the "leaveclan" command.
 */
void do_leavecla( CHAR_DATA *ch, char *argument )
{
    send_to_char( "If you want to LEAVECLAN, you have to spell it out.\n\r", ch );
